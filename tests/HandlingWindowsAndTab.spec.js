...
test("Handling multiple windows/Tabs",async({browser})=>
{
    ...
    /*WaitForEvent("backgroundpage")==>This mwthod will wait until any new page is opened and will
    return that new page Listens for any new page
    After reolving or fullfilled promises under Promise.all it will return new page
    */
